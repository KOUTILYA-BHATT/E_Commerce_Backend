...
CREATE TABLE `jt_ta` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_JT_TA_ON_ID` FOREIGN KEY (`id`) REFERENCES `jt_users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jt_ta`
--

LOCK TABLES `jt_ta` WRITE;
/*!40000 ALTER TABLE `jt_ta` DISABLE KEYS */;
/*!40000 ALTER TABLE `jt_ta` ENABLE KEYS */;
UNLOCK TABLES;
