...
--
-- Table structure for table `mps_mentor`
--

DROP TABLE IF EXISTS `mps_mentor`;
...
--
-- Dumping data for table `mps_mentor`
--

LOCK TABLES `mps_mentor` WRITE;
/*!40000 ALTER TABLE `mps_mentor` DISABLE KEYS */;
/*!40000 ALTER TABLE `mps_mentor` ENABLE KEYS */;
UNLOCK TABLES;
