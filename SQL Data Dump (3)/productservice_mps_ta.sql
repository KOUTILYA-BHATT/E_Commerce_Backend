...
--
-- Table structure for table `mps_ta`
--

DROP TABLE IF EXISTS `mps_ta`;
...
--
-- Dumping data for table `mps_ta`
--

LOCK TABLES `mps_ta` WRITE;
/*!40000 ALTER TABLE `mps_ta` DISABLE KEYS */;
/*!40000 ALTER TABLE `mps_ta` ENABLE KEYS */;
UNLOCK TABLES;
