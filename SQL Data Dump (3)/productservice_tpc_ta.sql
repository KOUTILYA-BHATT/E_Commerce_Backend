...
--
-- Table structure for table `tpc_ta`
--

DROP TABLE IF EXISTS `tpc_ta`;
...
--
-- Dumping data for table `tpc_ta`
--

LOCK TABLES `tpc_ta` WRITE;
/*!40000 ALTER TABLE `tpc_ta` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpc_ta` ENABLE KEYS */;
UNLOCK TABLES;
