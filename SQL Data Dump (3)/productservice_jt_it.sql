...
--
-- Table structure for table `jt_it`
--

DROP TABLE IF EXISTS `jt_it`;
...
CREATE TABLE `jt_it` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_JT_IT_ON_ID` FOREIGN KEY (`id`) REFERENCES `jt_users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jt_it`
--

LOCK TABLES `jt_it` WRITE;
/*!40000 ALTER TABLE `jt_it` DISABLE KEYS */;
/*!40000 ALTER TABLE `jt_it` ENABLE KEYS */;
UNLOCK TABLES;
